...
export default function Navbar() {
  ...
  const MobileModal: React.FC<MobileModalProps> = ({ isOpen, onClose, navigation }) => {
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
        <div className="w-11/12 max-w-md relative">
          ...
          <div className="relative bg-transparent rounded-xl p-6 text-white/90 shadow-lg ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/10 dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#8686f01f_inset]">
            <button onClick={onClose} className="float-right text-white/90 hover:text-white">
            ...
            <div className="mt-6 flex flex-col space-y-4">
              ...
              <div className="flex justify-center space-x-4">
                <Link href='https://x.com/gepstoken' className="text-white/70 hover:text-white">
                  <BsTwitterX size={20}/>
                </Link>
                <Link href='https://discord.com/invite/xg9uDTd6' className="text-white/70 hover:text-white">
                  <BsDiscord size={20}/>
                </Link>
                <Link href='https://t.me/gepstoken' className="text-white/70 hover:text-white">
  ...
  return (
    <div className="relative">
      ...
      <MobileModal isOpen={menuOpen} onClose={() => setMenuOpen(false)} navigation={navigation}/>
    </div>
  )
}